...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/Iwithyou2025/aimili-vpngate/main/install.sh)
```
...
```bash
curl -Ls https://raw.githubusercontent.com/Iwithyou2025/aimili-vpngate/main/install.sh -o install.sh
